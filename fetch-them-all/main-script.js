...
let stat = 0;
let pokeApiCalls = new Array; // Array for API URLs
const pokemons = new Array; // Array for pokemon data in json
...
//Fetch data from each API by iterating through its respective URL 
...
//Create pokemon table and its sorting options
...
//Get random pokemon different from the chosen one
...
//Draw canvas, animate the pokemon, check for winner, play again
